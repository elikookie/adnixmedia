...
export default function Home() {
  ...
  return (
    <div className="relative h-full overflow-hidden">
      ...
      <div className="fixed right-8 top-1/2 transform -translate-y-1/2 space-y-4 z-10">
        {[...Array(4)].map((_, index) => (
          <div
            key={index}
            className={`dot w-4 h-4 rounded-full cursor-pointer transition ${
      ...
      <div className="snap-y snap-mandatory overflow-y-auto h-full w-full">
        {/* Section 1 */}
        <section id="section-0" className="snap-start bg-gradient-to-r from-blue-400 to-blue-600 text-white h-screen flex items-center justify-center p-16">
          <div className="text-center">
            <h1 className="text-5xl font-extrabold mb-4">Welcome to Adnix Media</h1>
            <p className="text-2xl">Driving Bookings, Maximizing Revenue, and Growing Your Vacation Rental Business.</p>
          </div>
        </section>

        {/* Section 2 */}
        <section id="section-1" className="snap-start bg-white text-blue-900 h-screen flex items-center justify-center p-16">
        ...
        <section id="section-2" className="snap-start bg-blue-50 text-blue-900 h-screen flex items-center justify-center p-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8">
              ...
              <div className="bg-white border-2 border-indigo-200 rounded-lg p-8 transition transform hover:-translate-y-2 hover:shadow-2xl">
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-2xl font-semibold ml-4">Targeted Advertising</h3>
                </div>
                <p className="text-lg text-gray-600">Reach the right guests with precision advertising that targets travelers actively looking for vacation rentals.</p>
              </div>
              {/* Card 2 */}
              <div className="bg-white border-2 border-indigo-200 rounded-lg p-8 transition transform hover:-translate-y-2 hover:shadow-2xl">
                <div className="flex items-center mb-4">
              ...
              <div className="bg-white border-2 border-indigo-200 rounded-lg p-8 transition transform hover:-translate-y-2 hover:shadow-2xl">
                ...
                <p className="text-lg text-gray-600">Engage with travelers through well-crafted posts and ads that convert followers into bookings.</p>
              </div>
              {/* Card 4 */}
              <div className="bg-white border-2 border-indigo-200 rounded-lg p-8 transition transform hover:-translate-y-2 hover:shadow-2xl">
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-2xl font-semibold ml-4">Custom Content Creation</h3>
                </div>
                <p className="text-lg text-gray-600">Make your listings shine with compelling property descriptions, engaging blogs, and optimized content tailored to attract guests.</p>
              </div>
            </div>
          </div>
        </section>
